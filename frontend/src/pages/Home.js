    ...
    return (
        <div>
            ...
            <div id="homegrid">
                ...
                <div id="herotext">
                    <span id="sitename">NotesApp</span>
                    <br />
                    <br />
            ...
            <div id="homegrid2">
                ...
                <div className="panel" id='textpanel'>
                    ...
                    <ul>
                        <li>Go to <a href="https://facebook.com">this link</a> and send a message saying <b>'Join'</b> to sign up using WhatsApp.</li>
                        ...
                        <li>You can also 'pin' your important notes, and these notes will be available on the Pinned Notes page on the webapp for easy access.</li>
                    </ul>
                </div>
            </div>
            <div id='homeFooter'>
